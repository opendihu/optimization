                    ...
                    "instances": [{
                      ...
                      "Heun": {
                        ...
                        "CellML": {
                          ...
                          "setSpecificStatesCallEnableBegin":       1,#variables.specific_states_call_enable_begin_1,
                          "setSpecificStatesCallFrequency":         variables.specific_states_call_frequency,
                          "setSpecificStatesRepeatAfterFirstCall":  0.01,
                          "setSpecificStatesFrequencyJitter":       [0] ,
                          "setSpecificStatesCallInterval":          0,
        ...
        "Term2": { # solid mechanics (MuscleContractionSolver)
          "MuscleContractionSolver": {
            ...
            "OutputWriter": [
              {
                "format":             "Paraview",
                "outputInterval":     int(1.0 / variables.dt_3D * variables.output_interval),
                "filename":           "out/" + scenario_name + "/contraction_1",
                "fileNumbering":      "incremental",
                "binary":             True,
                "fixedFormat":        False,
                "onlyNodalValues":    True,
            ...
            "DynamicHyperelasticitySolver": {
              ...
              "dirichletBoundaryConditions":                            elasticity_dirichlet_bc_left,
              "neumannBoundaryConditions":                              elasticity_neumann_bc_left,
                    ...
                    "instances": [{
                      ...
                      "Heun": {
                        ...
                        "CellML": {
                          ...
                          "setSpecificStatesCallEnableBegin":       1,#variables.specific_states_call_enable_begin_2,
                          "setSpecificStatesCallFrequency":         variables.specific_states_call_frequency,
                          "setSpecificStatesRepeatAfterFirstCall":  0.01,
                          "setSpecificStatesFrequencyJitter":       [0] ,
                          "setSpecificStatesCallInterval":          0,
        ...
        "Term2": { # solid mechanics (MuscleContractionSolver)
          "MuscleContractionSolver": {
            ...
            "OutputWriter": [
              {
                "format":             "Paraview",
                "outputInterval":     int(1.0 / variables.dt_3D * variables.output_interval),
                "filename":           "out/" + scenario_name + "/contraction_2",
                "fileNumbering":      "incremental",
                "binary":             True,
                "fixedFormat":        False,
                "onlyNodalValues":    True,
            ...
            "DynamicHyperelasticitySolver": {
              ...
              "dirichletBoundaryConditions":                            elasticity_dirichlet_bc_right,
              "neumannBoundaryConditions":                              elasticity_neumann_bc_right,
              "updateDirichletBoundaryConditionsFunction":              None,
