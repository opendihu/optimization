                    ...
                    "Term2": { # diffusion term
                      "MultipleInstances": {
                        ...
                        "OutputWriter": [
                          {
                            "format":             "Paraview",
                            "outputInterval":     int(1.0 / variables.end_time),
           ...
           "Term2": { # solid mechanics (MuscleContractionSolver)
             "MuscleContractionSolver": {
               ...
               "DynamicHyperelasticitySolver": {
                 ...
                 "OutputWriter": 
                 [
                   {"format": "Paraview", "outputInterval": 1, "filename": "out/"+scenario_name+"/mechanics_1", "binary": True, "fixedFormat": False, "onlyNodalValues":True, "combineFiles":True, "fileNumbering": "incremental"},
                ...
                "OutputWriter": [
                  {
                    "format":             "Paraview",
                    "outputInterval":     int(1.0 / variables.dt_3D * variables.output_interval),
                    "filename":           "out/" + scenario_name + "/prestretch_2",
                    "fileNumbering":      "incremental",
                    "binary":             True,
                    "fixedFormat":        False,
                    "onlyNodalValues":    True,
                        ...
                        "instances": [{
                          ...
                          "Heun": {
                            ...
                            "CellML": {
                              ...
                              "setSpecificStatesCallEnableBegin":       0.0,
                              "setSpecificStatesCallFrequency":         variables.specific_states_call_frequency,
                              "setSpecificStatesRepeatAfterFirstCall":  0.01,
                              "setSpecificStatesFrequencyJitter":       [0] ,
                              "setSpecificStatesCallInterval":          0,
