...
prestretch_dirichlet_bc_1 = {}
prestretch_dirichlet_bc_2 = {}
...
for j in range(variables.bs_y):
  for i in range(variables.bs_x):
    ...
    prestretch_dirichlet_bc_2[k2*variables.bs_x*variables.bs_y + j*variables.bs_x + i] = [None,None,0.0,None,None,None]
    prestretch_dirichlet_bc_2[k1*variables.bs_x*variables.bs_y + j*variables.bs_x + i] = [None,None,0.0,None,None,None]
  ...
  "Coupling": { # prestretch
    ...
    "Term1": {
       "Coupling": {
        ...
        "Term1": { # fibers (FastMonodomainSolver) m1 prestretch 
          "MultipleInstances": { 
        ...
        "Term2": { # solid mechanics (MuscleContractionSolver) m1 orestretch
          "MuscleContractionSolver": {
            ...
            "HyperelasticitySolver": {
              ...
              "dirichletBoundaryConditions":                            prestretch_dirichlet_bc_1,
              "neumannBoundaryConditions":                              prestretch_neumann_bc_1,
    ...
    "Term2": {
      "Coupling": {
        ...
        "Term1": { # fibers (FastMonodomainSolver) m2 prestretch
          "MultipleInstances": { 
            "ranksAllComputedInstances":    list(range(n_ranks)),
            "nInstances":                   1,
        ...
        "Term2": { # solid mechanics (MuscleContractionSolver) m2 prestretch
          "MuscleContractionSolver": {
            "Pmax":                         variables.pmax,
    ...
    "Term2": { #contraction
      ...
      "Coupling": {
        ...
        "Term1": { # fibers (FastMonodomainSolver) m1
          "MultipleInstances": { 
            "ranksAllComputedInstances":    list(range(n_ranks)),
            "nInstances":                   1,
        ...
        "Term2": { # solid mechanics (MuscleContractionSolver) m1
          "MuscleContractionSolver": {
            "Pmax":                         variables.pmax,
            # "slotNames":                    ["lambdaContraction", "ldotContraction", "gammaContraction", "TContraction"],
            "slotNames":                    ["lambdaContraction1", "ldotContraction1", "gammaContraction1", "TContraction1"],
    ...
    "Term2": {
      "Coupling": {
        ...
        "Term1": { # fibers (FastMonodomainSolver) m2
          "MultipleInstances": { 
            "ranksAllComputedInstances":    list(range(n_ranks)),
            "nInstances":                   1,
        ...
        "Term2": { # solid mechanics (MuscleContractionSolver) m2
          "MuscleContractionSolver": {
            "Pmax":                         variables.pmax,
            "slotNames":                    ["lambdaContraction2", "ldotContraction2", "gammaContraction2", "TContraction2"],
            #"slotNames":                    ["lambda", "ldot", "gamma", "T"],
