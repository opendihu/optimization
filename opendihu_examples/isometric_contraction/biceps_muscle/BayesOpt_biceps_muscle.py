...
import time
import signal
import setup_BayesOpt_biceps_muscle
...
nu = setup_BayesOpt_biceps_muscle.nu
matern = setup_BayesOpt_biceps_muscle.matern
rbf = setup_BayesOpt_biceps_muscle.rbf

const = setup_BayesOpt_biceps_muscle.const
zero = setup_BayesOpt_biceps_muscle.zero

fixed_noise = setup_BayesOpt_biceps_muscle.fixed_noise
variable_noise = setup_BayesOpt_biceps_muscle.variable_noise

EI = setup_BayesOpt_biceps_muscle.EI
PI = setup_BayesOpt_biceps_muscle.PI
KG = setup_BayesOpt_biceps_muscle.KG
ES = setup_BayesOpt_biceps_muscle.ES

stopping_y = setup_BayesOpt_biceps_muscle.stopping_y
improvement_threshold = setup_BayesOpt_biceps_muscle.improvement_threshold
stopping_xy = setup_BayesOpt_biceps_muscle.stopping_xy
x_range = setup_BayesOpt_biceps_muscle.x_range
num_consecutive_trials = setup_BayesOpt_biceps_muscle.num_consecutive_trials

fixed_Yvar = setup_BayesOpt_biceps_muscle.fixed_Yvar
lower_bound = setup_BayesOpt_biceps_muscle.lower_bound
sobol_on = setup_BayesOpt_biceps_muscle.sobol_on
num_initial_trials = setup_BayesOpt_biceps_muscle.num_initial_trials
visualize = setup_BayesOpt_biceps_muscle.visualize
add_points = setup_BayesOpt_biceps_muscle.add_points
upper_bound = setup_BayesOpt_biceps_muscle.upper_bound
specific_relative_upper_bound = setup_BayesOpt_biceps_muscle.specific_relative_upper_bound
max_upper_bound = setup_BayesOpt_biceps_muscle.max_upper_bound
relative_prestretch_min = setup_BayesOpt_biceps_muscle.relative_prestretch_min
relative_prestretch_max = setup_BayesOpt_biceps_muscle.relative_prestretch_max
