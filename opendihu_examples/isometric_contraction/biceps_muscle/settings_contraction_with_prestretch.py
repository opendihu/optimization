                  ...
                  [{
                    ...
                    "Heun" : {
                      ...
                      "CellML" : {
                        ...
                        "setSpecificStatesCallEnableBegin":       variables.end_time,# [ms] first time when to call setSpecificStates
      ...
      "Term2": {        # solid mechanics
        "MuscleContractionSolver": {
          ...
          "HyperelasticitySolver": {
            ...
            "dirichletBoundaryConditions": variables.prestretch_dirichlet_bc,   # the initial Dirichlet boundary conditions that define values for displacements u and velocity v
      ...
      "Term2": {        # solid mechanics
        "MuscleContractionSolver": {
          ...
          "DynamicHyperelasticitySolver": {
            ...
            # boundary and initial conditions
            "dirichletBoundaryConditions": variables.contraction_dirichlet_bc,   # the initial Dirichlet boundary conditions that define values for displacements u and velocity v
